...
''',style={'border-style':'ridge',
    ...
    html.Table([
        ...
        html.Tr([
            ...
            html.Td(""),
            html.Td(html.Div([html.A('Room air ventilation rate w/outside air (per hour)', 
        ...
        html.Tr([
            ...
            html.Td(""),
            html.Td(html.Div([html.A('Virus removal rate due to additional control measures (per hour)', 
